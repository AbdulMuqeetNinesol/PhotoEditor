...
class EditingToolsAdapter(private val mOnItemSelected: OnItemSelected) :
    ...
    init {
        mToolList.add(ToolModel("Shape", R.drawable.shape, ToolType.SHAPE))
        ...
        mToolList.add(ToolModel("Crop", R.drawable.ic_baseline_crop_24, ToolType.CROP))
        mToolList.add(ToolModel("Filter", R.drawable.filter, ToolType.FILTER))
        mToolList.add(ToolModel("Emoji", R.drawable.emoji, ToolType.EMOJI))
//        mToolList.add(ToolModel("Sticker", R.drawable.ic_sticker, ToolType.STICKER))
        mToolList.add(ToolModel("Remove BG", R.drawable.remove, ToolType.BACKGROUNDREMOVER))
    }
}